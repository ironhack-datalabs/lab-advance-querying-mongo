...
We have learned some super useful query operators, that will help us to make much better queries to retrieve the data we need. We will continue using the **Crunchbase** database we used on the last exercise.
